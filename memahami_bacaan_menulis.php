...
<html lang="en">
	<head>
		...
		<title>SNBT | KEMAMPUAN MEMAHAMI BACAAN & MENULIS</title>
        <link
	...
	<body>
      ...
      require_once "dbconfig.php";
        ...
        ?>
				...
				<br>
        <br>
				<p align="center" class="mt-3"><b>KEMAMPUAN MEMAHAMI BACAAN & MENULIS</b></p>
				
        <form action="pengetahuan_kuantitatif.php" method="POST" id="frmSoal">
        <?php
            include "koneksi.php";
						// ORDER BY RAND() limit 15
            $query    = mysqli_query($koneksi, "SELECT * FROM memahami_bacaan_menulis ORDER BY RAND()");
                ...
                <?php
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query1  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_pemahaman WHERE id='$nomor' AND jawaban='$jawaban' and bobot=15");
                          ...
                          $query2  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_pemahaman WHERE id='$nomor' AND jawaban='$jawaban' and bobot=20");
                          ...
                          $query3  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_pemahaman WHERE id='$nomor' AND jawaban='$jawaban' and bobot=30");
                          ...
                          $query4  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_pemahaman WHERE id='$nomor' AND jawaban='$jawaban' and bobot=40");
                      ...
                      $hasil = 300 + $score1 + $score2 + $score3 + $score4; 

                      $id = $currentUser['id'];
                      $update = "update user set pengetahuan_pemahaman = '$hasil' where id = '$id'";
