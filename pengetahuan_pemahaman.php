...
<html lang="en">
	<head>
		...
		<title>SNBT | PENGETAHUAN & PEMAHAMAN UMUM</title>
        <link
	...
	<body>
      ...
      require_once "dbconfig.php";
        ...
        ?>
				...
				<br>
        <br>
				<p align="center" class="mt-3"><b>PENGETAHUAN & PEMAHAMAN UMUM</b></p>

        <form action="memahami_bacaan_menulis.php" method="POST" id="frmSoal">
        <?php
            include "koneksi.php";
						// ORDER BY RAND() limit 15
            $query    = mysqli_query($koneksi, "SELECT * FROM pengetahuan_pemahaman ORDER BY RAND()");
            	...
            	$score1   = 0;
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query1  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=20");
                          ...
                          $query2  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=18");
                          ...
                          $query3  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=17");
                          ...
                          $query4  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=15");
