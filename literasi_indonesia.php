	...
	<body>
      ...
      require_once "dbconfig.php";
        ...
        <?php
            ...
            $query    = mysqli_query($koneksi, "SELECT * FROM literasi_indonesia ORDER BY RAND()");
            	...
            	$score1   = 0;
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query7  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_kuantitatif WHERE id='$nomor' AND jawaban='$jawaban' and bobot=5");
                          ...
                          $query8  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_kuantitatif WHERE id='$nomor' AND jawaban='$jawaban' and bobot=8");
                          ...
                          $query9  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_kuantitatif WHERE id='$nomor' AND jawaban='$jawaban' and bobot=35");
