...
<html lang="en">
	<head>
		...
		<title>SNBT | PENALARAN MATEMATIKA</title>
        <link
	...
	<body>
      ...
      require_once "dbconfig.php";
		...
		<p align="center" class="mt-3"><b>PENALARAN MATEMATIKA</b></p>

        <form action="hasil_snbt.php" method="POST" id="frmSoal">
        <?php
            include "koneksi.php";
						// ORDER BY RAND() limit 15
            $query    = mysqli_query($koneksi, "SELECT * FROM penalaran_matematika ORDER BY RAND() limit 20");
        ...
        <tbody>    
                ...
                <?php
                    if(!empty($data['gambar'])){
                        echo "<tr><td><img src='assets/img/penalaran_matematika/$data[gambar]' width='300' height='300'></td><td></td></tr>";
                    }
                ?>
                <tr>
            	...
            	$score1   = 0;
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query1  = mysqli_query($koneksi, "SELECT * FROM literasi_inggris WHERE id='$nomor' AND jawaban='$jawaban' and bobot=20");
                          ...
                          $query2  = mysqli_query($koneksi, "SELECT * FROM literasi_inggris WHERE id='$nomor' AND jawaban='$jawaban' and bobot=50");
                          ...
                          $query3  = mysqli_query($koneksi, "SELECT * FROM literasi_inggris WHERE id='$nomor' AND jawaban='$jawaban' and bobot=60");
                      ...
                      $hasil = 300 + $score1 + $score2 + $score3; 

                      $id = $currentUser['id'];
                      $update = "update user set literasi_inggris = '$hasil' where id = '$id'";
