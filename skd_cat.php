...
<html lang="en">
	...
	<body>
      ...
      require_once "dbconfig.php";
        ...
        <form action="hasil_cat.php" method="POST" id="frmSoal">
        <?php
            include "koneksi.php";
        ...
        <tbody>    
                <input type="hidden" name="idtwk[]" value="<?php echo $datatwk['id']; ?>">
    ...
    <?php
		...
		<!-- col-md-6 col-lg-4 -->
							<table border="0" class="m-3 p-2 bg-warning d-flex rounded">
        <tbody>    
                <input type="hidden" name="idtkp[]" value="<?php echo $datatkp['id']; ?>">
    ...
    <?php
            ...
            ?>
								...
								<div align="center">
									<button class="btn btn-dark py-2 px-4 m-3" name="next" id='submitBtn' type="submit">Submit</button></td>  
								</div>
            </form>
