	...
	<body>
      ...
      require_once "dbconfig.php";
        ...
        <?php
            ...
            $query    = mysqli_query($koneksi, "SELECT * FROM pengetahuan_kuantitatif ORDER BY RAND() limit 20");
                ...
                <?php
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query1  = mysqli_query($koneksi, "SELECT * FROM memahami_bacaan_menulis WHERE id='$nomor' AND jawaban='$jawaban' and bobot=30");
                          ...
                          $query2  = mysqli_query($koneksi, "SELECT * FROM memahami_bacaan_menulis WHERE id='$nomor' AND jawaban='$jawaban' and bobot=34");
                          ...
                          $query3  = mysqli_query($koneksi, "SELECT * FROM memahami_bacaan_menulis WHERE id='$nomor' AND jawaban='$jawaban' and bobot=45");
