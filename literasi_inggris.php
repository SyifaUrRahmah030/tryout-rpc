	...
	<body>
      ...
      require_once "dbconfig.php";
        ...
        <?php
            ...
            $query    = mysqli_query($koneksi, "SELECT * FROM literasi_inggris ORDER BY RAND()");
                ...
                <?php
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query1  = mysqli_query($koneksi, "SELECT * FROM literasi_indonesia WHERE id='$nomor' AND jawaban='$jawaban' and bobot=15");
                          ...
                          $query2  = mysqli_query($koneksi, "SELECT * FROM literasi_indonesia WHERE id='$nomor' AND jawaban='$jawaban' and bobot=30");
                          ...
                          $query3  = mysqli_query($koneksi, "SELECT * FROM literasi_indonesia WHERE id='$nomor' AND jawaban='$jawaban' and bobot=20");
